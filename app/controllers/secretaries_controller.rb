class SecretariesController < ApplicationController
  ...
  def update
    # Filtrar valores vacíos de professional_ids
    filtered_params = secretary_params
    professional_ids = filtered_params.delete(:professional_ids)&.reject(&:blank?) || []
